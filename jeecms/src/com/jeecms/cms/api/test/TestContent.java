...
public class TestContent {
	...
	private static String testSaveContent(){
		String url="http://192.168.0.173:8080/jeecmsv8f/api/content/save.jspx";
	...
	private static String testUpdateContent(){
		String url="http://192.168.0.173:8080/jeecmsv8f/api/content/update.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("id="+159);
		paramBuff.append("&channelId="+75);
		paramBuff.append("&modelId="+1);
	...
	private static String testDelContent(){
		String url="http://192.168.0.173:8080/jeecmsv8f/api/content/del.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("ids="+"159");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
		paramBuff.append("&appId="+appId);
		paramBuff.append("&nonce_str="+nonce_str);
	...
	private static String testRecycleContent(){
		String url="http://192.168.0.173:8080/jeecmsv8f/api/content/recycle.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("ids="+"159");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
	...
	private static String testCheckContent(){
		String url="http://192.168.0.173:8080/jeecmsv8f/api/content/check.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("ids="+"159");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
	...
	private static String testRejectContent(){
		String url="http://192.168.0.173:8080/jeecmsv8f/api/content/reject.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("ids="+"159");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
	...
	private static String testUpContent(){
		String url="http://192.168.0.173:8080/jeecmsv8f/api/content/up.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("id="+"159");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		paramBuff.append("&appId="+appId);
	...
	private static String testDownContent(){
		String url="http://192.168.0.173:8080/jeecmsv8f/api/content/down.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("id="+"159");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
	...
	private static String testBuyContent(){
		//购买API地址
		//String url="http://192.168.0.173:8080/jeecmsv8f/api/content/buy.jspx";
		//打赏API地址
		String url="http://192.168.0.173:8080/jeecmsv8f/api/content/reward.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testUploadDoc(String local){
		String url="http://192.168.0.173:8080/jeecmsv8f/api/upload/o_upload_doc.jspx?";
		FileUpload fileUpload = new FileUpload();
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		StringBuffer paramBuff=new StringBuffer();
		Map<String, String>param=new HashMap<String, String>();
